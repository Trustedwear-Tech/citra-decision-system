...
ENVSUBST_VARS='${CITRA_AGENT_LLM_BASE_URL} ${CITRA_AGENT_LLM_API_KEY} ${CITRA_AGENT_MODEL} ${OPENCLAW_HOME} ${CITRA_AGENT_CONTEXT_WINDOW} ${CITRA_AGENT_MAX_OUTPUT_TOKENS} ${CITRA_MCP_URL} ${CITRA_AGENT_SCOPED_TOKEN} ${CITRA_AGENT_PROXY_BASE_URL} ${SMART_APP_INTERNAL_SECRET}'
