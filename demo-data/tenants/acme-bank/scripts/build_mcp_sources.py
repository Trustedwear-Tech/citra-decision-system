        ...
        write_actions=[{
            ...
            "input_schema": {
                ...
                "properties": {
                    ...
                    "status": {"type": "string", "enum": ["approved", "rejected", "under_review"], "description": "approved | rejected | under_review."},
        ...
        write_actions=[{
            ...
            "input_schema": {
                ...
                "properties": {
                    ...
                    "channel": {"type": "string", "enum": ["call", "sms", "whatsapp", "field", "legal"], "description": "call | sms | whatsapp | field | legal."},
                    "attempted_at": {"type": "string", "description": "ISO timestamp of the attempt."},
                    "outcome": {"type": "string", "enum": ["ptp", "no_contact", "dispute", "refused", "paid", "wrong_number"], "description": "ptp | no_contact | dispute | refused | paid | wrong_number."},
        ...
        write_actions=[
            {
                ...
                "input_schema": {
                    ...
                    "properties": {
                        ...
                        "status": {"type": "string", "enum": ["approved", "rejected", "settled"], "description": "approved | rejected | settled."},
